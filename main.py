...
def player_operation(game_id):
    ...
    if not success:
        ...
        match GameStatus.get(game.status):
            case GameStatus.PLAYER_OPERATION|GameStatus.BET|GameStatus.NEW|GameStatus.GAME_OVER:
                dame_dict=game.to_json_object()
                return jsonify(dame_dict),200
            case _ :
...
def get_game(game_id):
    ...
    if game is None:
        return "The game can't found.You need to stat a new game!",200
